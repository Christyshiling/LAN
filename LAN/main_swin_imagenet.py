...
root_directory = 'result/log24_02_08_aug_swin_data2_imageNet'  # 请替换为你的根目录路径
...
step2_network = torchvision.models.swin_b(weights=torchvision.models.Swin_B_Weights)
step2_network.head = nn.Linear(1024, num_classes)

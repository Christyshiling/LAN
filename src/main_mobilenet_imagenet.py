...
root_directory = 'result/log24_02_08_imagenet_mobilenet_data'  # 请替换为你的根目录路径
if not os.path.exists(root_directory):
    os.makedirs(root_directory)

# 调用函数以获取训练集和测试集的平均图像尺寸
train_image_width, train_image_height, test_image_width, test_image_height = get_average_image_size("data")
...
step2_network = torchvision.models.mobilenet_v3_large(weights=torchvision.models.MobileNet_V3_Large_Weights)
step2_network.classifier = nn.Sequential(nn.Linear(960, num_classes))

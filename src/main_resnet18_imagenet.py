...
from network_v2 import Step2Network, Step1Network
from utility import get_average_image_size
from train3 import work1, work2

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
# 指定包含训练集和测试集子文件夹的根目录
root_directory = 'result/log24_03_08_resnet18_bs64_data2'  # 请替换为你的根目录路径
...
step2_network = torchvision.models.resnet18(weights='DEFAULT')
step2_network.fc = nn.Linear(512, num_classes)
step2_network = step2_network.to(device)
...
train_batch_size = 64
test_batch_size = 128
train_dataset1 = datasets.ImageFolder(root="data_2/train", transform=train_transform1)
trainloader1 = DataLoader(train_dataset1, batch_size=train_batch_size, shuffle=True)
train_dataset2 = datasets.ImageFolder(root="data_2/train", transform=train_transform2)
...
work1(step1_network, optimizer1, criterion1, trainloader1, testloader, num_epochs,
      root_directory)

work2(step1_network, step2_network, optimizer2, criterion2, trainloader2, testloader, num_epochs,
      root_directory)

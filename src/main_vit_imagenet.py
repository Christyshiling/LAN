...
root_directory = 'result/log24_02_02_imagenet_vit_data2'  # 请替换为你的根目录路径
...
step2_network = torchvision.models.vit_b_16(weights=torchvision.models.ViT_B_16_Weights.IMAGENET1K_V1)
step2_network.classifier = nn.Sequential(nn.Linear(768, num_classes))
